...
##Exercise 4C: Based on the Normal-QQ plot the data is normal. The amount of variation that can be explained by the model is 7.89%, which was calculated by using a linear model and computing the r-squared value. Based on the Scheffe Test, the mean birth weight of a non-black baby will be greater than a black baby and the mean birth weight of a baby whose mom did not smoke will be greater than a baby whose mom did smoke. 
